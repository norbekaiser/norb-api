...
echo "Adding Procedure for Adding a Local User\n";
run_query($DBCSQL,__DIR__.'/../SQL/users_local_add.sql');
echo "Adding Procedure for Authorizing Local User\n";
run_query($DBCSQL, __DIR__ . '/../SQL/users_local_authenticate.sql');
echo "Adding Procedure for Changing User Password \n";
run_query($DBCSQL, __DIR__ . '/../SQL/users_local_change_password.sql');
echo "Adding Procedure for Adding External LDAP user\n";
run_query($DBCSQL,__DIR__.'/../SQL/users_ldap_add.sql');
